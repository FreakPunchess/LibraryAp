...
public class PersonDAO {
    ...
    public List<Book> booksByPerson(int ownerId) {
        return jdbcTemplate.query("SELECT * FROM book WHERE owner_id=?", new Object[]{ownerId}, new BeanPropertyRowMapper<>(Book.class));
    }
}
